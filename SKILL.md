...
- **变体 2（2026-09-11 实证）**：在 Windows 上过滤 eslint 大 JSON 报告时，**不要用** PowerShell 5.1 中转：`Out-File -Encoding utf8` 会损坏 JSON（BOM/重编码，node 解析报 `Expected ',' or '}'`），`Get-Content -Raw | ConvertFrom-Json` 对 4MB 级 JSON 会卡死超时。正确做法：`eslint --format json --output-file <path>` 让 eslint 自己写文件，再用 `node -e "JSON.parse(fs.readFileSync(...))"` 过滤统计（秒级）。
...
### 60. tldraw ����ָ�벶���̵���״�ϰ�ť�� click + antd Popover ����������״�����ڲ˵����ȫʧЧ

- **��ǩ**��`tldraw` `antd` `popover` `pointer-capture` `click��ʧ` `arti` `canvas`
- **��Ŀ**��`D:\project\2026\gitlab\arti`��canvas ��Ƭģ�ͣ�tldraw 5.3.1 + antd 6��
- **����**���� ���� tldraw ��״ HTMLContainer �ϡ������� stopPropagation �ı�����֮��İ�ť���� antd `Popover trigger='click'` ��ס�����޷�Ӧ�����㲻�������� ��Ϊ pointerdown �ֶ� open �󵯲�"��һ�¾͹�"���� ����򿪺��˵�����޷�Ӧ�����"�ϴ�ͼƬ"�����ļ�ѡ��������
- **����**�����������ӡ���
  1. tldraw �������Լ��� pointerdown �������� `setPointerCapture`����ť pointerdown ð�ݵ������󣬺��� click �䵽����Ԫ���ϣ�antd �ղ���������
  2. �� pointerdown ���ֶ� toggle �ܿ� open ��ԭ�� click �ִ��� antd trigger �� toggle �� ͬһ�ε��������˫���л� = ���أ�
  3. antd Popover Ĭ�� `getPopupContainer = triggerNode.parentNode`��������Ⱦ�� tldraw ��״�����ڣ��˵���� pointerdown ͬ�������������̵� click���������ڵ� Popover ��������Ϊ�䵯�����������ڵ��� stopPropagation �������ڣ���
- **�޸�**����ť `onPointerDown` ֻ�� `event.stopPropagation()`��**��Ҫ preventDefault**���������� click��**��Ҫ�ֶ� toggle**�������� antd�������� content ���ڵ��һ�� `onPointerDown={e => e.stopPropagation()}`���� `getPopupContainer={() => document.body}` ��ʡ���Ҳ����� antd �汾 API����hover ������ `trigger='hover'` + `mouseEnterDelay={0}` + `mouseLeaveDelay={0.15}` �ܿ� open ���ɡ�
- **��֤**��Ӳˢ�º�㰴ť�����ȶ����ϣ��˵��� click �����ɷ����ļ�ѡ������������
- **��ѵ**��tldraw ��״�ϷŽ���Ԫ�أ�������� pointerdown ð��·������û�� stopPropagation��������һ��"click ������/pointer �¼�����"���Ȼ��� `setPointerCapture`�������������������ģ����� trigger ���յ� click�����õ����������յ� click�����㶼���ܱ������̡�

### 61. tldraw ճ�������ļ�����Դ���������ƣ��޷�Ӧ����`navigator.clipboard.read()` ��֧���ļ��б�

- **��ǩ**��`tldraw` `paste` `clipboard` `navigator.clipboard.read` `�����ļ�ճ��` `arti` `canvas`
- **��Ŀ**��`D:\project\2026\gitlab\arti`��canvas��tldraw 5.3.1��
- **����**����ͼ��������ͼ�����ݣ�Ctrl+V / Ctrl+Shift+V ճ��������������Դ�������� Ctrl+C ����ͼƬ�ļ���ճ����ȫ�޷�Ӧ���޿�Ƭ������ʾ����
- **����**��tldraw ��ԭ�� paste ��������`useNativeClipboardEvents`�����ȵ��� `navigator.clipboard.read()`���ɹ�ʱֻ���䷵�ص� ClipboardItems��`e.clipboardData.files` ���� fallback ���� things Ϊ�ջ��ı�ʱ��׷�ӣ���Chrome ���첽 Clipboard API **��֧����Դ���������Ƶ��ļ��б�**��CF_HDROP����read() �ɹ����ص�ȡ�����ļ� �� fallback ���������� �� ��Ĭ��������ͼ�ߵ���ͼ�����ݣ�image/png����read() ���õ�������������
- **�޸�**���� window **����׶�**�� paste ������ֱ�Ӵ��� `event.clipboardData.files`����ͼ�뱾���ļ�ͳһ���Խ����ߣ������ `preventDefault + stopPropagation` ��� tldraw �ĺ�������tldraw �� `registerExternalContentHandler('files')` ��������ק��drop ������ paste �¼���������� `editor.user.getIsPasteAtCursorMode() ? editor.inputs.getCurrentPagePoint() : undefined` �� tldraw ԭ��Ϊ���롣
- **��֤**��Ӳˢ�º���Դ���������� jpg �� Ctrl+Shift+V �������زĿ�+�����������ߣ���ͼճ����Ϊ���䡣
- **��ѵ**���Ų�"������ X ���� Y ������"ʱ����ȷ�Ͽ���ߵ���ͬ�� `event.clipboardData` �����첽 `navigator.clipboard.read()`����������������ͬ�������ò����ļ��б�����ҪȨ�ޡ���ʽ֧���٣������������ + stopPropagation ���ƹ���ܼ��������ĸɾ�������

### 62. Ctrl+Shift+V��ճ��Ϊ���ı���paste �¼����ݱ� Chrome Ԥ���ˡ���ͼ��/�ļ��õ��� DataTransfer

- **��ǩ**��`chrome` `paste` `ctrl+shift+v` `clipboardDataΪ��` `navigator.clipboard.read` `arti` `canvas`
- **��Ŀ**��`D:\project\2026\gitlab\arti`��canvas ճ����
- **����**��Ctrl+V ճ��ͼƬ������ͬһ������������ Ctrl+Shift+V ����ȫ�޷�Ӧ�������־��paste �¼��ճ��ɷ����� `clipboardData.types=[]��files=0��items=0`�����ּ������� `types=['text/plain']` ������
- **����**��Chrome �� Ctrl+Shift+V ʵ��Ϊ"ճ��Ϊ���ı�"��paste-and-match-style�����ɷ� paste �¼�ǰ��� DataTransfer **Ԥ���˵�ֻʣ text/plain ��ʾ**��ͼ��/�ļ��б�û���ı���ʾ �� �¼�������ȫΪ�գ�ҳ���κη�֧���ò������ݡ��ⲻ�� tldraw ���⣬���������Ϊ��
- **�޸�**��paste �¼�����Ϊ���� tracked �� shift ʱ������ `navigator.clipboard.read()` ��ԭʼ�����壨�����¼�����Ӱ�죩������ ClipboardItems �� `image/*|video/*` ���� getType �� Blob ת File ��ͳһý����ߣ�������������Դ�������ļ��б� CF_HDROP���첽 API ������֧�֣�����ʾ"��ʹ�� Ctrl+V"��
- **��֤**��Ӳˢ�º󶤶���ͼ/��ͼ����ͼ�� Ctrl+Shift+V ��������+���ߣ����� Ctrl+Shift+V ��������Դ�������ļ� Ctrl+Shift+V ��ʾ���� Ctrl+V��ƽ̨���ƣ��޷��ƹ�����
- **��ѵ**���Ų�"��ݼ� A ��������ݼ� B ������"���ȴ���־�� paste �¼��� `types/files/items`�����¼��ɷ�������Ϊ�� = �����Ԥ���ˣ����Ǵ��� bug��sync `event.clipboardData` �� async `navigator.clipboard.read()` ����������ǰ�������ļ��б����� Ctrl+V�����������ƹ����ı�������ͼ�����ݣ��� Ctrl+Shift+V ���¼�ʱ�������� API ��ϲ��ܸ���ȫ���������� #61����

### 63. tldraw `editor.getShape(undefined)` ֱ���� TypeError����ѡ id �����пպ��ٴ�

- **��ǩ**��`tldraw` `getShape` `undefined` `TypeError` `��ѡprops` `arti` `canvas`
- **��Ŀ**��`D:\project\2026\gitlab\arti`��canvas �鿨���л��
- **����**��`TypeError: Cannot read properties of undefined (reading 'id') at Editor.getShape`��React ����߽������
...
### 67. `pnpm dev -- --port 3013` 的 `--` 被原样透传给 vite，端口参数失效（退回配置默认端口）

- **标签**：`pnpm` `vite` `port` `参数透传` `windows` `arti` `dev-server`
- **现象**：要重启 arti 画布 dev 到 3013，执行 `pnpm dev -- --port 3013` 后 vite 日志显示命令行为 `vite "--" "--port" "3013"`，服务器起在 `vite.config.ts` 配置的默认 3011 上，3013 无监听。
- **根因**：pnpm run 不需要 npm 风格的 `--` 分隔符；多写的 `--` 被当作字面参数传给 vite，vite 无法解析 `"--"` 后续参数，静默回退配置文件端口（且 `strictPort` 未开时不报错）。
- **修复**：直接 `pnpm dev --port 3013`（pnpm 会把脚本名后的参数原样转发给脚本）。另外 Windows 上 `Start-Process -FilePath "pnpm"` 起不来（pnpm 是 .cmd shim），要用 `Start-Process cmd.exe -ArgumentList '/c','pnpm dev --port 3013 > log 2>&1' -WorkingDirectory <proj> -WindowStyle Hidden`。
- **验证**：`Get-NetTCPConnection -LocalPort 3013 -State Listen` 确认监听 PID；日志 `vite-dev.log` 显示 `Local: http://localhost:3013/`。
- **教训**：① pnpm 传参不需要 `--`，npm 习惯带过来会踩坑；② vite 起在"错误的默认端口"时先看命令行参数是否真的生效（日志第一行 `$ vite ...` 会原样回显参数）；③ Windows 启后台 dev 一律走 `cmd /c + 重定向日志`，既能读启动日志又避免 shim 解析失败。

### 68. 画布尺寸类改动被误判"没生效"：屏幕像素 = 画布单位 × 缩放，先反推缩放再排查代码

- **标签**：`arti` `canvas` `tldraw` `zoom` `尺寸` `误判` `验证方法`
- **现象**：把生成器卡结果区展示尺寸改为基准换算（16:9 → 683×384 画布单位）后，用户截图反馈"修改没生效，16:9 结果区明显过大"——截图中结果区约 990×555 屏幕像素，看似远大于 683×384。
- **根因**：tldraw 画布内容随相机缩放渲染，**屏幕像素 = 画布单位 × 缩放比例**。用户当时在 ~145% 缩放下查看：683×384 × 1.45 ≈ 990×557，与截图完全吻合——修改其实已经生效，是缩放造成的视觉误判。
- **修复/排查方法**：遇到"尺寸改动没生效/过大"反馈，先别怀疑代码，用截图反推：① 量结果区/卡片的屏幕像素，除以预期画布单位得缩放（宽、高两个方向算出的缩放一致即可确认是缩放显示问题）；② 用已知字号做锚点佐证（如工具栏 13px、提示词 16px 的字宽反推缩放）；③ 让用户把右下角缩放重置到 100% 再验证，100% 下 1 画布单位 = 1 屏幕像素。
- **验证**：用户确认 100% 缩放下 16:9=683×384、1:1=512×512 尺寸正确，无需改代码。
- **教训**：① 画布（tldraw/Konva 类）尺寸需求的提出与验收都必须带上缩放比例，以 100% 为准；② 截图里缩放指示器常被裁掉/截不到，用"字号锚点"反推最可靠；③ 等面积换算出的 683×384 这类尺寸，在 1.45 缩放下≈990×557，视觉上和"没生效的大尺寸"几乎一样，极易误判。

### 69. 改了代码里的默认值但行为没变：per-canvas localStorage 设置（canvas-settings:<id>）覆盖代码默认值

- **标签**：`arti` `canvas` `localStorage` `设置持久化` `默认值覆盖` `canvas-settings` `误判`
- **现象**：把画布默认节点尺寸常量 160→350 后，用户通过底部工具栏新建的素材卡/生成占位卡仍是 ~240，疑似改动没生效。
- **根因**：画布设置按画布持久化在 localStorage（`canvas-settings:<canvasId>`），加载时 `{...DEFAULT_CANVAS_SETTINGS, ...saved}` 合并——saved 里任何字段都覆盖代码默认值，新常量只在"无持久化设置"时生效。该画布此前在设置弹窗保存过 defaultNodeWidth/Height=240。**关键推理**：素材卡创建直接取 `settings.defaultNodeWidth`（page.tsx:8093，无 max(240,...) 下限），卡片是 240 即可反推生效设置值就是 240——而非 bundle 未更新（旧 bundle 会是 160）；生成占位卡 `max(240, 240)=240` 同样吻合。
